...
/// </summary>
        ...
        /// <summary>
        /// A generated connection allowance group, the steel equivalent of isAutoReinforcementGroup.
        /// </summary>
        public bool isAutoConnectionGroup { get; set; }

        /// <summary>
        /// True for any group the import generated itself. Those are rebuilt from the settings on
        /// every run, so they must not be pruned or reinforced like a group holding real elements.
        /// </summary>
        public bool IsAutoGenerated()
        {
            return isAutoReinforcementGroup == true || isAutoConnectionGroup == true;
        }
...
//               suffix = " (Substructure)";
        ...
        */
        ...
        public CarboGroup Copy()
        {
            ...
            result.isAutoConnectionGroup = this.isAutoConnectionGroup;
            result.Grade = this.Grade;
            result.VolumeLink = this.VolumeLink;
        ...
        public object Clone()
        {
...

            {
                ...
                isAutoConnectionGroup = this.isAutoConnectionGroup,
        ...
        internal void copyValues(CarboGroup carboGroup)
        {
            ...
            isAutoConnectionGroup = carboGroup.isAutoConnectionGroup;
